...
CMS.api.API = Ext.extend(Ext.util.Observable, /** @lends CMS.api.API.prototype */ {
     ...
     * @private
     */
    methods:  ['get', 'getSelected', 'set', 'setName', 'setInfo', 'refresh', 'preventRendering', 'remove', 'openInsertWindow', 'moveUp', 'moveDown', 'duplicate', 'select', 'deselect', 'getInsertable', 'insert', 'openFormPanel', 'openTreePanel', 'getColorById', 'applyRichTextEditorConfig', 'createPreviewTicket', 'updateFormFieldConfig', 'processInsertedUnits', 'getVisualHelpersState', 'getModule', 'i18n', 'getResolutions', 'getCurrentResolution', 'getImageUrl', 'getAllUnitIds', 'getMediaUrl'],
