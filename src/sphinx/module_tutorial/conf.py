# -*- coding: utf-8 -*-
#
# Rukzuk Module Development documentation build configuration file, created by
...
project = u'rukzuk Module Development'
copyright = u'2014, rukzuk AG'
...
htmlhelp_basename = 'RukzukModuleDevelopmentdoc'
